...
| [Movie Lists](/docs/api-reference/movie_lists)         | `tmdb.movieLists`       | `MovieListsAPI`    | Access curated movie lists: popular, top rated, now playing, and upcoming.        |
...
| [TV Series](/docs/api-reference/tv_series)             | `tmdb.tvSeries`         | `TVSeriesAPI`      | Get TV series details, episodes, seasons, credits, and recommendations.           |
| [TV Series Lists](/docs/api-reference/tv_series_lists) | `tmdb.tvSeriesLists`    | `TVSeriesListsAPI` | Access curated TV series lists: popular, top rated, airing today, and on the air. |
