---
title: People List
description: Query the people that have been changed in the last 24 hours.
---

Query the people that have been changed in the last 24 hours, or since a specified date.

```ts
async people_list(): Promise<PaginatedResponse<ChangeResultItem>>
```

> **TMDB Reference:** [People List](https://developer.themoviedb.org/reference/changes-people-list)
