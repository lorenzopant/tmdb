...
const url = tmdb.images.backdrop(tv.backdrop_path, "w1280");
...
const url = tmdb.images.logo(network.logo_path, "w185");
...
const url = tmdb.images.profile(person.profile_path, "w185");
...
const url = tmdb.images.still(episode.still_path, "w300");
