 ...
 */
export const TMDB_ERRORS: Map<string, { message: string; http_status: number }> = new Map([
	...
	["35", { message: "Invalid date range: Should be a range no longer than 14 days.", http_status: 422 }],
	["36", { message: "Invalid date range: Should be a range no longer than 14 days.", http_status: 422 }],
	["37", { message: "Invalid date range: Should be a range no longer than 14 days.", http_status: 422 }],
	["38", { message: "Invalid date range: Should be a range no longer than 14 days.", http_status: 422 }],
	["39", { message: "Invalid date range: Should be a range no longer than 14 days.", http_status: 422 }],
	["40", { message: "Invalid date range: Should be a range no longer than 14 days.", http_status: 422 }],
]);
